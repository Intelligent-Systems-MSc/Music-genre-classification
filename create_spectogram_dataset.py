...
for dir in tqdm(os.listdir("data/genres")):
    # For each directory, iterate over the audio files
    for file in tqdm(os.listdir("data/genres/" + dir)):
        # Load the audio file
        y, sr = librosa.load("data/genres/" + dir + "/" + file)
        ...
        file_path = os.path.abspath("data/dataset/" + dir)
        ...
        plt.savefig("data/dataset/" + dir + "/" + file_name + ".png")
        plt.close()
