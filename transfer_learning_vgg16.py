...
class CNNModel:
    def __init__(self):
        self.model = None
        self.model_name = "transfer_learning_vgg16"
    ...
    def build_model(self):
        ...
        vggmodel=VGG16(include_top=False, weights='imagenet', input_tensor=None, input_shape=(50, 80, 3), pooling=None)
        ...
        self.model.compile(optimizer=tf.keras.optimizers.RMSprop(learning_rate=0.000005), loss='categorical_crossentropy', metrics=['accuracy'])
    ...
    def train_model(self, train_generator,validation_generator, epochs=10):
        ...
        # Training the model
        self.model_history = self.model.fit(train_generator, epochs=epochs,validation_data=validation_generator,callbacks=[early_stopping_monitor], shuffle=True)
...
def main():
    ...
    model.train_model(train_generator,validation_generator, epochs=100)
