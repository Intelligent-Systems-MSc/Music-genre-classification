...
def main():
    ...
    parser.add_argument("--dataset_path_out", type=str, default="data/images/nftt2048hop512bins128/" ,help="Path of the dataset")
    parser.add_argument("--feature", type=str,default= "mfcc" ,help="Feature to extract : melspectrogram, mfcc, chroma_stft, chroma_cqt, chroma_cens")
